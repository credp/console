# Scanout SDRAM controller experiment

Generated with `experiments/new-experiment` from Template_MiSTer revision
14d9ed0. `files.qip` imports `../../rtl/scanout-sdram-controller`. SDRAM pins
remain safely undriven until the board-facing command engine and PHY are ready.

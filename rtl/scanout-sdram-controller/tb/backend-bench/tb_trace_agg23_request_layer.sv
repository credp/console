...
module tb_trace_agg23_request_layer;
    ...
    initial begin
        ...
        $display("TRACE_RESULT backend=agg23_request_layer requests=%0d accepted=%0d completed=%0d deadline_misses=%0d max_accept_delay_ns=%0d max_completion_latency_ns=%0d min_deadline_slack_ns=%0d",
    ...
    initial begin
        ...
        $fatal(1, "agg23 request-layer trace replay watchdog issued=%0d completed=%0d",
               issued, completed);
    end
endmodule
